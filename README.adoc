...
// URIs:
:uri-qg-status: https://sonarcloud.io/dashboard?id=alejandro-alvarez-sonarsource_windows-msbuild-opencppcoverage-actions-sc
:img-qg-status: https://sonarcloud.io/api/project_badges/measure?project=alejandro-alvarez-sonarsource_windows-msbuild-opencppcoverage-actions-sc&metric=alert_status
:uri-build-status: https://github.com/alejandro-alvarez-sonarsource/windows-msbuild-opencppcoverage-actions-sc/actions/workflows/build.yml
:img-build-status: https://github.com/alejandro-alvarez-sonarsource/windows-msbuild-opencppcoverage-actions-sc/actions/workflows/build.yml/badge.svg

image:{img-build-status}[Build Status, link={uri-build-status}]
image:{img-qg-status}[Quality Gate Status,link={uri-qg-status}]

*The test coverage shown here works on both SonarQube and SonarCloud. This project is analysed on https://sonarcloud.io/dashboard?id=alejandro-alvarez-sonarsource_windows-msbuild-opencppcoverage-actions-sc[SonarCloud]!*
